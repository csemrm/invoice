<table cellpadding="5" cellspacing="0" width="100%" style=" border: 1px solid #078DB9">
    ...
    <tr align="left" >
        ...
        <td style="background:#E0E6E6; color:#111;text-align: right;border: 1px solid #078DB9"></td>
    </tr>
    ...
    <tr align="left" >
        ...
        <td style="background:#E0E6E6; color:#111;border: 1px solid #078DB9;text-align: right"></td>
    </tr>
    ...
    <tr align="left" >
        ...
        <td style="color:#111;text-align: right;border: 1px solid #078DB9"></td>
    </tr>
</table> 
</div>